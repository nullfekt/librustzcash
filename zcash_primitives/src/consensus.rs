...
impl Parameters for MainNetwork {
    fn activation_height(&self, nu: NetworkUpgrade) -> Option<BlockHeight> {
        match nu {
            ...
            NetworkUpgrade::Blossom => Some(BlockHeight(10_000_000_000)),
            NetworkUpgrade::Heartwood => Some(BlockHeight(10_000_000_000)),
            NetworkUpgrade::Canopy => Some(BlockHeight(10_000_000_000)),
            NetworkUpgrade::Nu5 => Some(BlockHeight(10_000_000_000)),
            #[cfg(feature = "zfuture")]
